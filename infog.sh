#!/bin/bash
# InfoG v1.0
# coded by alwaysabdulr (Don't change, read the lincense!)
# Github: https://github.com/alwaysabdulr/infog
# Instagram: arz_beats
# YouTube : abdulkollam123@gmail.com
...
printf "\e[1;32m  .::.        Recoded by alwaysabdulr       .::.\e[0m\n"
printf "\n"
